      ...
      <div className="flex-1 min-w-0 flex flex-col gap-3 order-2 lg:order-1">
        ...
        <motion.div variants={staggerItem} className="flex items-center gap-3 text-sm text-gray-500 flex-wrap">
          ...
          <button
            ...
            className="lg:hidden ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-white text-xs font-semibold text-gray-600 hover:bg-gray-50 transition-colors shadow-sm"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            </svg>
            Filters
            <svg className={`w-3 h-3 text-gray-400 transition-transform ${filtersOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <AnimatePresence mode="wait" custom={tabDir}>
            ...
            >
              {isError ? (
                ...
                <div className="py-16 text-center bg-white rounded-xl border border-gray-100 shadow-sm">
                  <p className="text-3xl mb-2">📋</p>
                  <p className="text-sm font-semibold text-gray-400">No {activeTab === 'All' ? '' : TAB_LABEL[activeTab]} tickets</p>
                </div>
              ) : (
                <div className="space-y-2">
